...
function findFavoriteClothes(closet, favoriteClothes) {
  for (let i = 0; i < closet.length; i++) {
    if (closet[i] === favoriteClothes) {
      return `Favorite clothes found at position ${i + 1} in the closet.`;
    }
  }
  return "Favorite clothes not found in the closet.";
}

// Example usage
const closet = ["Shirt", "Jeans", "T-shirt", "Favorite Clothes", "Jacket"];
const favoriteClothes = "Favorite Clothes";

console.log(findFavoriteClothes(closet, favoriteClothes));
